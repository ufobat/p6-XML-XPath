...
subset Operator of Str where{$_ ~~ <equal not-equal smaller-than greater-than smaller-equal greater-equal pipe or and multiply div mod plus minus unary-minus>.any}
