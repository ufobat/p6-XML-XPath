subset Axis of Str where {$_ ~~ <child self attribute descendant descendant-or-self namespace parent ancestor following-sibling preceding-sibling following preceding>.any};
